        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8 w-full mx-auto mb-20">
          <div className="space-y-5">
            ...
            <p className="text-muted font-normal">
              I'm a passionate MERN Stack developer who loves creating
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-5 cursor-pointer">
              <Link
                href={"https://www.instagram.com/_fardin_zz/"}
                className="bg-foreground/5 w-10 h-10 rounded-full flex justify-center items-center hover:bg-foreground/10 transition-colors"
              >
                <FaInstagram className="text-foreground" />
              </Link>
              <Link
                href={"https://www.facebook.com/fardin.faruk.tofu7/"}
                className="bg-foreground/5 w-10 h-10 rounded-full flex justify-center items-center hover:bg-foreground/10 transition-colors"
              >
                <FaFacebook className="text-foreground" />
              </Link>
              <Link
                href={"https://github.com/fardinfaruk-bd"}
                className="bg-foreground/5 w-10 h-10 rounded-full flex justify-center items-center hover:bg-foreground/10 transition-colors"
              >
